...
func TestEncodeConfiguration(t *testing.T) {
	...
	expected := map[string]string{
		...
		"traefik.Middlewares.Middleware7.ForwardAuth.TLS.Key":                             "foobar",
		"traefik.Middlewares.Middleware7.ForwardAuth.TrustForwardHeader":                  "true",
		"traefik.Middlewares.Middleware8.Headers.AccessControlAllowCredentials":           "true",
		"traefik.Middlewares.Middleware8.Headers.AccessControlAllowHeaders":               "foobar, fiibar",
		"traefik.Middlewares.Middleware8.Headers.AccessControlAllowMethods":               "foobar, fiibar",
		"traefik.Middlewares.Middleware8.Headers.AccessControlAllowOrigin":                "foobar",
		"traefik.Middlewares.Middleware8.Headers.AccessControlExposeHeaders":              "foobar, fiibar",
		"traefik.Middlewares.Middleware8.Headers.AccessControlMaxAge":                     "600",
		"traefik.Middlewares.Middleware8.Headers.AddVaryHeader":                           "true",
		"traefik.Middlewares.Middleware8.Headers.AllowedHosts":                            "foobar, fiibar",
		"traefik.Middlewares.Middleware8.Headers.BrowserXSSFilter":                        "true",
		"traefik.Middlewares.Middleware8.Headers.ContentSecurityPolicy":                   "foobar",
		"traefik.Middlewares.Middleware8.Headers.ContentTypeNosniff":                      "true",
